...
import com.sinigr.wikipediaarticles.core.BaseFragment
...
class ArticlesListFragment : BaseFragment(), ArticlesListView {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    presenter = get { parametersOf(requireActivity()) }
